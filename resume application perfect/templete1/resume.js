...
addBtnskill.addEventListener("click", function () {
  let html = `<li><textarea name="" id="" class="skills" cols="43" rows="1" placeholder="Skill" oninput="auto_grow(this)"></textarea> <button id="subSkill" class="subskill">-</button></li>`;
...
btnExp.addEventListener("click", function () {
  ...
  <li><textarea name="" id="" placeholder="Work Experince" cols="43" rows="1" class="skills" oninput="auto_grow(this)"></textarea><button>-</button> </li> `;
  expCont.insertAdjacentHTML("beforeend", html);
});
const ulCont = document.getElementsByClassName("exp-container");
let ex = 0;
function exp() {
  let html = `  <li><textarea name="" id="" placeholder="Work Experince" cols="43" rows="1" class="skills" oninput="auto_grow(this)"></textarea><button>-</button> </li>`;
